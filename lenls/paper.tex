...
%                                    \toctitle is used
%
\author{Ji\v{r}\'i Mar\v{s}\'ik\inst{1} \and Maxime Amblard\inst{2}}
%
\authorrunning{Ji\v{r}\'i Mar\v{s}\'ik et al.} % abbreviated author list (for running head)
%
%%%% list of authors for the TOC (use if author list has to be modified)
\tocauthor{Ji\v{r}\'i Mar\v{s}\'ik and Maxime Amblard}
%
